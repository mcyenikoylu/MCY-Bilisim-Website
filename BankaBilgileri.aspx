<%@ Page Title="" Language="C#" MasterPageFile="~/MP1.master" AutoEventWireup="true" CodeFile="BankaBilgileri.aspx.cs" Inherits="Default2" %>
...
<div class="body_resize">
    ...
    <h3>Destek</h3>
        ...
        <div class="left">
        <h4>Banka Bilgilerimiz</h4>
        <p>Yapım Aşamasındayız.</p>
        <p>&nbsp;</p>
        </div>
