...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		// user logs on your system. ck findere girdik return falseyi true  yapacagýz dostlar bu hali ile servere
        // gönderin calcakdýr þimdi localde calýþmasý icin ayar yapalým  basit 
	...
	public override void SetConfig()
	{
		...
		// The base URL used to reach files in CKFinder through the browser hemen bu uzantýya Tilda koyalým.
